...
// in pizza_app/test/presentation/bloc/todo_bloc_test.dart.
...
import 'package:pizza_app/common/utils/failure.dart' as _i6;
import 'package:pizza_app/features/todo/domain/entities/todo.dart' as _i7;
import 'package:pizza_app/features/todo/domain/repositories/todo_repository.dart'
    as _i2;
import 'package:pizza_app/features/todo/domain/usecases/get_todo.dart' as _i4;
...
class MockGetTodo extends _i1.Mock implements _i4.GetTodo {
  MockGetTodo() {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Todo>>> execute() =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
